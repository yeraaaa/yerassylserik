...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 md:w-1/2 md:mb-0 md:mt-0 flex justify-center md:justify-end">
          <Image
            src="/profile.jpeg"
            alt="Profile Photo"
            width={400}
